...
@RestController
@RequestMapping("/api/logproject-kafka")
public class LogprojectKafkaResource {
    private final Logger log = LoggerFactory.getLogger(LogprojectKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LogprojectKafkaResource(KafkaProperties kafkaProperties) {
